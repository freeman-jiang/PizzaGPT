...
{"---".join(["-----" + newline +  f"EXAMPLE {i}" + newline + ex + newline + "------" + newline for i, ex in enumerate(examples)])}
...
if (
    ...
    # if len(i) > 0:
    #     objective = i
    objective =  "Order a pizza to 151 Charles St W Suite 100, Kitchener, ON N2G 1H6. Pay using cash."
